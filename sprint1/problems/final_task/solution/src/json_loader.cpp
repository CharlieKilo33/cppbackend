...
namespace json_loader
{
    ...
    {
        if (!mapItem.as_object().contains("roads"))
            return;
    ...
    {
        if (!mapItem.as_object().contains("buildings"))
            return;
